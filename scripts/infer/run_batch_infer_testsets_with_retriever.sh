...
usage() {
    cat <<'EOF'
Usage:
  bash scripts/infer/run_batch_infer_testsets_with_retriever.sh
...
OUTPUT_DIR="${OUTPUT_DIR_ARG:-${LOG_DIR:-$ROOT_DIR/log}/batch_infer_testsets}"
...
echo "Starting batch inference with $INFER_PYTHON"
